...
import connectors.RegistrationOfIndividualWithIdConnector
...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  val registrationOfIndividualWithIdBaseUrl: String = {
    val baseUrl = generateBaseUrl(RegistrationOfIndividualWithIdConnector.connectorName)
    println("registrationOfIndividualWithIdBaseUrl:" + baseUrl)
    baseUrl
  }
